...
public class CaptureServiceImplTest {
    ...
    void captureRequest() throws Exception {
        ...
        Mockito.doReturn(responseMockedGet).when(client).initiateGetTransactionStatus(any());
    ...
    void captureRequestError() throws Exception{
        ...
        Mockito.doReturn(responseMocked).when(client).initiateGetTransactionStatus(any());
        Mockito.doReturn(responseMocked).when(client).initiateConfirmationPayment(any());
    ...
    void captureRequestException() throws Exception{
        Mockito.doThrow(new HttpCallException("foo", "bar")).when(client).initiateGetTransactionStatus(any());
