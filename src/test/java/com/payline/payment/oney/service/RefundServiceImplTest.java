...
public class RefundServiceImplTest {
    ...
    public void refundRequestTestOK() throws IOException, URISyntaxException {
        ...
        Mockito.doReturn(responseMocked1).when(httpClient).doGet(Mockito.anyString(), Mockito.anyString(), Mockito.anyString(),
    ...
    public void refundRequestTestKO() throws IOException, URISyntaxException {
        ...
        Assertions.assertTrue(response.getClass() == RefundResponseFailure.class);
